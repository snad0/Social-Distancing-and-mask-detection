...
labels= lb.fit_transform(labels) #text to numerical
...
X_train, X_test, y_train, y_test = train_test_split( data, labels,test_size=0.2, stratify=labels, random_state=12)
